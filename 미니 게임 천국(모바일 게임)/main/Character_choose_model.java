...
//############캐릭터 선택 페이지 model
public class Character_choose_model {
    ...
    public Character_choose_model(int id, int imageCourse, String courseTitle, String quantityCourses) {
        Id = id;
    ...
    public Character_choose_model(int imageCourse, String courseTitle, String quantityCourses) {
        this.imageCourse = imageCourse;
        this.courseTitle = courseTitle;
        this.quantityCourses = quantityCourses;
    }
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof Character_choose_model) {
            ...
            Character_choose_model characterchoosemodel = (Character_choose_model) other;
            return characterchoosemodel.getId()==(this.getId());
        }
